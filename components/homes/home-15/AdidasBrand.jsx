...
export default function AdidasBrand() {
  ...
  useEffect(() => {
    let mounted = true;
    // Use homepageService to get featured products for Adidas brand
    api.homepage
      ...
      .then((res) => {
        ...
        console.log("adidas products: ", featuredProducts)
      })
      .catch((e) => setErr(e.message || "Failed to load adidas products"))
  ...
  const swiperOptions = useMemo(
    () => ({
      ...
      pagination: false,
      navigation: {
        nextEl: ".adidas-carousel__next",
        prevEl: ".adidas-carousel__prev",
      },
      breakpoints: {
  ...
  if (loading) {
    return (
        <section className="adidas-brand-section">
          <div className="adidas-bg-pattern"></div>
          <div className="adidas-bg-overlay"></div>
          <div className="container">
            <div className="adidas-brand-logo">
              <h2 className="adidas-logo-text">ADIDAS</h2>
            </div>
    ...
    return (
      ...
      <section className="adidas-brand-section">
       ...
       <div className="d-lg-none">
         <Link href="/shop" className="adidas-mobile-banner">
           <div className="adidas-mobile-bg">
             <img
               src="/assets/images/brands/brand2.png"
               alt="Adidas"
               className="adidas-mobile-img"
