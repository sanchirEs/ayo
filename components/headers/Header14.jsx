...
export default function Header14() {
  ...
  return (
    ...
    >
      <div className="header-top" style={{ backgroundColor: "#495D35" }}>
        <div className="container d-flex container align-items-center" style={{ color: "white"}}>
          <ul className="list-unstyled d-flex flex-1 gap-3 m-0">
            <li>
              <a href="#" className="menu-link menu-link_us-s d-flex align-items-center gap-2" style={{ color: "white" }}>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
          ...
          <div className="heeader-top__right flex-1 d-flex gap-1 justify-content-end" style={{ color: "white", fontSize: "0.9rem" }}>
            Хүргэлтийн ачааллаас хамааран онлайн захиалга 24-48 цагт хүргэгдэж байна.
          </div>
        </div>
      </div>
      <div className="header-desk_type_8" style={{ backgroundColor: "#F4F7F5" }}>
          ...
          <div className="container d-flex align-items-center my-2">
            <div className="flex-1 d-flex align-items-center gap-3">
              ...
              <div className="service-promotion__content-wrap">
                <h3 className="service-promotion__title h6 text-uppercase mb-0" style={{ color: "var(--color-primary)" }}>
                  Need Help
                </h3>
                <p className="service-promotion__content fs-base mb-0" style={{ color: "var(--color-text)" }}>
                  +0020 500 5832
                </p>
              </div>
            </div>
 ...
 {user ? (
        ...
        <div className="header-bottom" style={{ borderTop: "1px solid rgba(47, 79, 47, 0.1)" }}>
